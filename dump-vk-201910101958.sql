...
CREATE TABLE `likes` (
  ...
  CONSTRAINT `likes_ibfk_4` FOREIGN KEY (`note_id`) REFERENCES `notes` (`id`),
  CONSTRAINT `likes_ibfk_5` FOREIGN KEY (`profile_id`) REFERENCES `profiles` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `media` (
  ...
  `body` text,
  `filname` varchar(255) DEFAULT NULL,
  `size` int(11) DEFAULT NULL,
  `metadata` json DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `notes` (
  ...
  CONSTRAINT `notes_ibfk_2` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `playlist` (
  ...
  CONSTRAINT `playlist_ibfk_1` FOREIGN KEY (`track_id`) REFERENCES `music` (`id`),
  CONSTRAINT `playlist_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'evgenij','popov','rostovg@r.ru','fdlgjkdjg',345346536),(2,'loplop','gut','dfgjhh@sgf.ry',NULL,NULL);
...
-- Dump completed on 2019-10-10 19:58:54
